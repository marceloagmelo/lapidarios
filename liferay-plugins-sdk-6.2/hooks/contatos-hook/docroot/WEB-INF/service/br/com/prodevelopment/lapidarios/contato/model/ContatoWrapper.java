...
public class ContatoWrapper implements Contato, ModelWrapper<Contato> {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<br.com.prodevelopment.lapidarios.contato.model.Contato> toCacheModel() {
		return _contato.toCacheModel();
	}

	@Override
	public br.com.prodevelopment.lapidarios.contato.model.Contato toEscapedModel() {
		return new ContatoWrapper(_contato.toEscapedModel());
	}

	@Override
	public br.com.prodevelopment.lapidarios.contato.model.Contato toUnescapedModel() {
