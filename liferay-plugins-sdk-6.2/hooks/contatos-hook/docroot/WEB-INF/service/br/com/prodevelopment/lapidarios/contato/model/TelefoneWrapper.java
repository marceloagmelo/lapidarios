...
public class TelefoneWrapper implements Telefone, ModelWrapper<Telefone> {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<br.com.prodevelopment.lapidarios.contato.model.Telefone> toCacheModel() {
		return _telefone.toCacheModel();
	}

	@Override
	public br.com.prodevelopment.lapidarios.contato.model.Telefone toEscapedModel() {
		return new TelefoneWrapper(_telefone.toEscapedModel());
	}

	@Override
	public br.com.prodevelopment.lapidarios.contato.model.Telefone toUnescapedModel() {
