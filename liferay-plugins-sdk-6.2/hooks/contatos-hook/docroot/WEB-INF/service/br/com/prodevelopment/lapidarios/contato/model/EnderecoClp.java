...
public class EnderecoClp extends BaseModelImpl<Endereco> implements Endereco {
	...
	public void setCidade(String cidade) {
		...
		if (_enderecoRemoteModel != null) {
			try {
				...
				method.invoke(_enderecoRemoteModel, cidade);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public String toXmlString() {
		...
		sb.append("br.com.prodevelopment.lapidarios.contato.model.Endereco");
	...
	private Class<?> _clpSerializerClass = br.com.prodevelopment.lapidarios.contato.service.ClpSerializer.class;
}