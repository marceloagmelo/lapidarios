...
import br.com.prodevelopment.lapidarios.contato.NoSuchEnderecoException;
import br.com.prodevelopment.lapidarios.contato.model.Endereco;
import br.com.prodevelopment.lapidarios.contato.model.impl.EnderecoImpl;
import br.com.prodevelopment.lapidarios.contato.model.impl.EnderecoModelImpl;
...
public class EnderecoPersistenceImpl extends BasePersistenceImpl<Endereco>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_CIDADE =
		new FinderPath(EnderecoModelImpl.ENTITY_CACHE_ENABLED,
			EnderecoModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_CIDADE",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public List<Endereco> findByC_CIDADE(long companyId, String cidade)
		throws SystemException {
		return findByC_CIDADE(companyId, cidade, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Endereco> findByC_CIDADE(long companyId, String cidade,
		int start, int end) throws SystemException {
		return findByC_CIDADE(companyId, cidade, start, end, null);
	}
	...
	public List<Endereco> findByC_CIDADE(long companyId, String cidade,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Endereco endereco : list) {
				if ((companyId != endereco.getCompanyId()) ||
						!StringUtil.wildcardMatches(endereco.getCidade(),
							cidade, CharPool.UNDERLINE, CharPool.PERCENT,
							CharPool.BACK_SLASH, true)) {
					list = null;
	 ...
	 */
	@Override
	public Endereco findByC_CIDADE_First(long companyId, String cidade,
		OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = fetchByC_CIDADE_First(companyId, cidade,
				orderByComparator);
	 ...
	 */
	@Override
	public Endereco fetchByC_CIDADE_First(long companyId, String cidade,
		OrderByComparator orderByComparator) throws SystemException {
		List<Endereco> list = findByC_CIDADE(companyId, cidade, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Endereco findByC_CIDADE_Last(long companyId, String cidade,
		OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = fetchByC_CIDADE_Last(companyId, cidade,
				orderByComparator);
	 ...
	 */
	@Override
	public Endereco fetchByC_CIDADE_Last(long companyId, String cidade,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByC_CIDADE(companyId, cidade);

		if (count == 0) {
			return null;
		}

		List<Endereco> list = findByC_CIDADE(companyId, cidade, count - 1,
				count, orderByComparator);
	...
	public Endereco[] findByC_CIDADE_PrevAndNext(long enderecoId,
		long companyId, String cidade, OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = findByPrimaryKey(enderecoId);
	...
	protected Endereco getByC_CIDADE_PrevAndNext(Session session,
		Endereco endereco, long companyId, String cidade,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByC_CIDADE(long companyId, String cidade)
		throws SystemException {
		for (Endereco endereco : findByC_CIDADE(companyId, cidade,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(endereco);
		}
	}
	 ...
	 */
	@Override
	public int countByC_CIDADE(long companyId, String cidade)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_CIDADE;

		Object[] finderArgs = new Object[] { companyId, cidade };
	...
	private static final String _FINDER_COLUMN_C_CIDADE_CIDADE_1 = "endereco.cidade LIKE NULL";
	private static final String _FINDER_COLUMN_C_CIDADE_CIDADE_2 = "endereco.cidade LIKE ?";
	private static final String _FINDER_COLUMN_C_CIDADE_CIDADE_3 = "(endereco.cidade IS NULL OR endereco.cidade LIKE '')";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_G_CIDADE =
		new FinderPath(EnderecoModelImpl.ENTITY_CACHE_ENABLED,
			EnderecoModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByC_G_CIDADE",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	...
	public List<Endereco> findByC_G_CIDADE(long companyId, long groupId,
		...
		return findByC_G_CIDADE(companyId, groupId, cidade, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<Endereco> findByC_G_CIDADE(long companyId, long groupId,
		String cidade, int start, int end) throws SystemException {
		return findByC_G_CIDADE(companyId, groupId, cidade, start, end, null);
	}
	...
	@Override
	public List<Endereco> findByC_G_CIDADE(long companyId, long groupId,
		String cidade, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
	...
	public Endereco findByC_G_CIDADE_First(long companyId, long groupId,
		String cidade, OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = fetchByC_G_CIDADE_First(companyId, groupId, cidade,
				orderByComparator);
	...
	public Endereco fetchByC_G_CIDADE_First(long companyId, long groupId,
		String cidade, OrderByComparator orderByComparator)
		throws SystemException {
		List<Endereco> list = findByC_G_CIDADE(companyId, groupId, cidade, 0,
				1, orderByComparator);
	...
	public Endereco findByC_G_CIDADE_Last(long companyId, long groupId,
		String cidade, OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = fetchByC_G_CIDADE_Last(companyId, groupId, cidade,
				orderByComparator);
	...
	public Endereco fetchByC_G_CIDADE_Last(long companyId, long groupId,
		String cidade, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByC_G_CIDADE(companyId, groupId, cidade);

		if (count == 0) {
			return null;
		}

		List<Endereco> list = findByC_G_CIDADE(companyId, groupId, cidade,
				count - 1, count, orderByComparator);
	...
	public Endereco[] findByC_G_CIDADE_PrevAndNext(long enderecoId,
		long companyId, long groupId, String cidade,
		OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = findByPrimaryKey(enderecoId);
		...
		try {
			...
			array[0] = getByC_G_CIDADE_PrevAndNext(session, endereco,
					companyId, groupId, cidade, orderByComparator, true);

			array[1] = endereco;

			array[2] = getByC_G_CIDADE_PrevAndNext(session, endereco,
					companyId, groupId, cidade, orderByComparator, false);
	...
	protected Endereco getByC_G_CIDADE_PrevAndNext(Session session,
		Endereco endereco, long companyId, long groupId, String cidade,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByC_G_CIDADE(long companyId, long groupId, String cidade)
		throws SystemException {
		for (Endereco endereco : findByC_G_CIDADE(companyId, groupId, cidade,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(endereco);
		}
	}
	 ...
	 */
	@Override
	public int countByC_G_CIDADE(long companyId, long groupId, String cidade)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_C_G_CIDADE;

		Object[] finderArgs = new Object[] { companyId, groupId, cidade };
	...
	private static final String _FINDER_COLUMN_C_G_CIDADE_CIDADE_1 = "endereco.cidade LIKE NULL";
	private static final String _FINDER_COLUMN_C_G_CIDADE_CIDADE_2 = "endereco.cidade LIKE ?";
	private static final String _FINDER_COLUMN_C_G_CIDADE_CIDADE_3 = "(endereco.cidade IS NULL OR endereco.cidade LIKE '')";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_CIDADE = new FinderPath(EnderecoModelImpl.ENTITY_CACHE_ENABLED,
			EnderecoModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Endereco> findByCIDADE(String cidade) throws SystemException {
	 ...
	 */
	@Override
	public List<Endereco> findByCIDADE(String cidade, int start, int end)
		throws SystemException {
	...
	public List<Endereco> findByCIDADE(String cidade, int start, int end,
		...
		if ((list != null) && !list.isEmpty()) {
			for (Endereco endereco : list) {
				if (!StringUtil.wildcardMatches(endereco.getCidade(), cidade,
							CharPool.UNDERLINE, CharPool.PERCENT,
							CharPool.BACK_SLASH, true)) {
					list = null;
	 ...
	 */
	@Override
	public Endereco findByCIDADE_First(String cidade,
		OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = fetchByCIDADE_First(cidade, orderByComparator);
	 ...
	 */
	@Override
	public Endereco fetchByCIDADE_First(String cidade,
		OrderByComparator orderByComparator) throws SystemException {
		List<Endereco> list = findByCIDADE(cidade, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Endereco findByCIDADE_Last(String cidade,
		OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = fetchByCIDADE_Last(cidade, orderByComparator);
	 ...
	 */
	@Override
	public Endereco fetchByCIDADE_Last(String cidade,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Endereco> list = findByCIDADE(cidade, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Endereco[] findByCIDADE_PrevAndNext(long enderecoId, String cidade,
		OrderByComparator orderByComparator)
		throws NoSuchEnderecoException, SystemException {
		Endereco endereco = findByPrimaryKey(enderecoId);
		...
		try {
			...
			array[0] = getByCIDADE_PrevAndNext(session, endereco, cidade,
					orderByComparator, true);

			array[1] = endereco;

			array[2] = getByCIDADE_PrevAndNext(session, endereco, cidade,
					orderByComparator, false);
	...
	protected Endereco getByCIDADE_PrevAndNext(Session session,
		Endereco endereco, String cidade, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByCIDADE(String cidade) throws SystemException {
		for (Endereco endereco : findByCIDADE(cidade, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(endereco);
		}
	}
	...
	private static final String _FINDER_COLUMN_CIDADE_CIDADE_1 = "endereco.cidade LIKE NULL";
	private static final String _FINDER_COLUMN_CIDADE_CIDADE_2 = "endereco.cidade LIKE ?";
	private static final String _FINDER_COLUMN_CIDADE_CIDADE_3 = "(endereco.cidade IS NULL OR endereco.cidade LIKE '')";
	...
	protected Endereco toUnwrappedModel(Endereco endereco) {
		...
		enderecoImpl.setCidade(endereco.getCidade());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.br.com.prodevelopment.lapidarios.contato.model.Endereco")));
