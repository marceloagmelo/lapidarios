...
import br.com.prodevelopment.lapidarios.contato.service.base.EnderecoLocalServiceBaseImpl;
...
public class EnderecoLocalServiceImpl extends EnderecoLocalServiceBaseImpl {
	...
	public Endereco addEndereco(long companyId, long groupId,
			...
			String bairro, String cidade, String uf, long paisId, int tipo,
	...
	public Endereco update(long enderecoId, long companyId, String className,
			...
			String cidade, String uf, long paisId, int tipo, boolean principal)
