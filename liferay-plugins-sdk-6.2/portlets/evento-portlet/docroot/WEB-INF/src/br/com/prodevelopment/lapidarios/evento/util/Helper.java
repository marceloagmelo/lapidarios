package br.com.prodevelopment.lapidarios.evento.util;
...
public class Helper {
	...
	/**
	 * Verifica se um string é nulo, vazio ou prenchido somente com espaços.
	 * 
	 * @param str
	 *            o string a ser avaliado.
	 * @return <code>true</code> caso o string é nulo, vazio ou prenchido
	 *         somente com espaços.
	 */
	 ...
	 * 
	 * @param collection
	 *            a collection a ser avaliada.
	 * @return <code>true</code> caso a collection seja nula ou vazia.
	 */
	 ...
	 * 
	 * @param map
	 *            a map a ser avaliada.
	 * @return <code>true</code> caso a map seja nula ou vazia.
	 */
	...
	/**
	 * Compara a igualdade entre dois objetos livre observando a nulidade de um
	 * dois objetos.
	 * 
	 * @param first
	 *            O primeiro objeto.
	...
	/**
	 * Valida se um determinado email é válido segundo a expressão regular
	...
	public static boolean isCPF(Object value) {
		...
		return isEmptyString(strValue) ? false : validaCPF(Long
				.parseLong(strValue));
	}
	...
	public static boolean isCNPJ(Object value) {
		...
		String strValue = onlyDigits(value.toString());
		return isEmptyString(strValue) ? false : validaCNPJ(Long
				.parseLong(strValue));
	}
	...
	/**
	 * Compara dois Calendar contendo data e hora para determinar a precedência
	 * entre eles.
	 * 
	 * @param first
	 *            primeiro calendar na comparacação.
	 * @param second
	 *            segundo calendar na comparacação.
	 ...
	 *             Caso seja passado algum parâmetro <I><B>nulo</B></I>.
	 */
	 ...
	 * 
	 * @param first
	 *            primeira data na comparacação.
	 * @param second
	 *            segunda data na comparacação.
	 * @return -1 se a primeira data é anterior a segunda, 0 se são iguais e 1
	 *         se a primeira data é posterior a segunda.
	 * @throws IllegalArgumentException
	 *             Caso seja passado algum parâmetro <I><B>nulo</B></I>.
	 */
	public static int compareDate(Calendar first, Calendar second) {
		...
		if (first.get(Calendar.YEAR) == second.get(Calendar.YEAR)) {
			if (first.get(Calendar.DAY_OF_YEAR) > second
	 ...
	 * 
	 * @param first
	 *            primeiro horário na comparacação.
	 * @param second
	 *            segundo horário na comparacação.
	 * @return -1 se o primeiro horário é anterior ao segundo, 0 se são iguais e
	 *         1 se o primeiro horário é posterior ao segundo.
	 * @throws IllegalArgumentException
	 *             Caso seja passado algum parâmetro <I><B>nulo</B></I>.
	 */
	...
	public static ArrayList<String> getHoras() {
		ArrayList<String> horas = new ArrayList<String>();
		for (int h = 0; h < 24; h++) {
			for (int m = 0; m < 59; m++) {
				horas.add(zerosEsquerda(String.valueOf(h), 2) + ":"
						+ zerosEsquerda(String.valueOf(m), 2));
			}
		}
		return horas;
	}
