...
import br.com.prodevelopment.lapidarios.evento.service.EventoInscricaoService;
...
/**
 * Provides the base implementation for the evento inscricao remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.prodevelopment.lapidarios.evento.service.impl.EventoInscricaoServiceImpl}.
 * </p>
 *
 * @author Marcelo Melo
 ...
 * @generated
 */
public abstract class EventoInscricaoServiceBaseImpl extends BaseServiceImpl
	implements EventoInscricaoService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link br.com.prodevelopment.lapidarios.evento.service.EventoInscricaoServiceUtil} to access the evento inscricao remote service.
	 */
	...
	private EventoInscricaoServiceClpInvoker _clpInvoker = new EventoInscricaoServiceClpInvoker();
}