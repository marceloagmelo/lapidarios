...
public class DateUtil {
	...
	public static String getDateExtenso(Date data, boolean completa) {
		String diaf = null;
		String mesf = null;
		String retorno = null;
		Calendar calendar = new GregorianCalendar();
	...
	public static String getDateDiaSemana(Date data) {
		SimpleDateFormat sdf = new SimpleDateFormat("E", LOCALE_BRASIL);
	...
	public static List<Integer> generateRangeYears(int startYear, int endYear,
			String orderBy) {
	...
	public static int diferencaEntreHoras(String horaInicial, String horaFinal) {
		...
		try {
			...
			/*
			 * System.out.println(horas + " hora(s) " + minutos + " minuto(s) "+
			 * segundos + " segundo(s)");
			 */
	...
	public static long calcularMillisEntreDuasDatas(Calendar dataInicial,
			Calendar dataFinal) {
		return (dataFinal.getTimeInMillis() - dataInicial.getTimeInMillis());
	}

	public static long calcularMillisEntreDuasDatas(Date dataInicial,
			Date dataFinal) {
		return DateUtil.calcularMillisEntreDuasDatas(
				DateUtil.dateToCalendar(dataInicial),
				DateUtil.dateToCalendar(dataFinal));
	}

	public static long calcularTempoTotalEmMillis(Calendar dataInicial,
			Calendar dataFinal) {
		return (dataInicial.getTimeInMillis() + dataFinal.getTimeInMillis());
	}

	public static long calcularTempoTotalEmMillis(Date dataInicial,
			Date dataFinal) {
		return DateUtil.calcularTempoTotalEmMillis(
				DateUtil.dateToCalendar(dataInicial),
				DateUtil.dateToCalendar(dataFinal));
	}
