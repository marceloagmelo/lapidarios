 ...
 * @generated
 */
public abstract class EventoNaoInscritoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public EventoNaoInscritoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(EventoNaoInscritoLocalServiceUtil.getService());
		setClass(EventoNaoInscrito.class);

		setClassLoader(br.com.prodevelopment.lapidarios.evento.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("eventoNaoInscritoId");
	}
}