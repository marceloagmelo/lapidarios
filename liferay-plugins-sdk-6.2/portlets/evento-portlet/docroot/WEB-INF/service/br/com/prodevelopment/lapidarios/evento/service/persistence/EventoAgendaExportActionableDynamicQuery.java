 ...
 * @generated
 */
public class EventoAgendaExportActionableDynamicQuery
	extends EventoAgendaActionableDynamicQuery {
	public EventoAgendaExportActionableDynamicQuery(
	...
	protected void addCriteria(DynamicQuery dynamicQuery) {
		...
		if (_portletDataContext.isInitialPublication()) {
			...
			StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(EventoAgenda.class.getName());
	...
	protected void performAction(Object object)
		...
		EventoAgenda stagedModel = (EventoAgenda)object;
