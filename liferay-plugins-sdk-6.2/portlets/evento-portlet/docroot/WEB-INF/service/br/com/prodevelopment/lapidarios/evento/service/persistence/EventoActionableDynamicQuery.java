 ...
 * @generated
 */
public abstract class EventoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public EventoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(EventoLocalServiceUtil.getService());
		setClass(Evento.class);

		setClassLoader(br.com.prodevelopment.lapidarios.evento.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("eventoId");
	}
}