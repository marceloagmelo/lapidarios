 ...
 * @generated
 */
public abstract class EventoAgendaActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public EventoAgendaActionableDynamicQuery() throws SystemException {
		setBaseLocalService(EventoAgendaLocalServiceUtil.getService());
		setClass(EventoAgenda.class);

		setClassLoader(br.com.prodevelopment.lapidarios.evento.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("eventoAgendaId");
	}
}