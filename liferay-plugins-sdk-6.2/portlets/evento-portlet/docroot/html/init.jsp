...
<%
	...
	boolean permissaoConfigEvento = true;/*permissionChecker
			.hasPermission(scopeGroupId,
					Constantes.RESOURCE_FUNCIONARIO, scopeGroupId,
					ActionKeys.PERMISSIONS);*/
	boolean permissaoAddEvento = true;/*permissionChecker.hasPermission(
			scopeGroupId, Constantes.RESOURCE_FUNCIONARIO,
			scopeGroupId, Constantes.PERMISSAO_ADD);*/
	boolean permissaoUpdateEvento = true;/*permissionChecker
			.hasPermission(scopeGroupId,
					Constantes.RESOURCE_FUNCIONARIO, scopeGroupId,
					ActionKeys.UPDATE);*/
	boolean permissaoDeleteEvento = true;/*permissionChecker
			.hasPermission(scopeGroupId,
					Constantes.RESOURCE_FUNCIONARIO, scopeGroupId,
					ActionKeys.DELETE);*/
%>
