...
/**
 * Provides the local service interface for Associado. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcelo Melo
 * @see AssociadoLocalServiceUtil
...
public interface AssociadoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssociadoLocalServiceUtil} to access the associado local service. Add custom service methods to {@link br.com.prodevelopment.associado.service.impl.AssociadoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
