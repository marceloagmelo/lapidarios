 ...
 * @generated
 */
public class AssociadoLocalServiceClp implements AssociadoLocalService {
	public AssociadoLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName35 = "fetchByUSUARIO";

		_methodParameterTypes35 = new String[] { "long" };

		_methodName36 = "fetchByCPF_CNPJ";

		_methodParameterTypes36 = new String[] { "java.lang.String" };

		_methodName37 = "fetchByRG_INSCRICAO";

		_methodParameterTypes37 = new String[] { "java.lang.String" };

		_methodName38 = "fetchByOD_POLISHOP";
	...
	public br.com.prodevelopment.associado.model.Associado addAssociado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(associado) });
		}
		catch (Throwable t) {
		...
		return (br.com.prodevelopment.associado.model.Associado)ClpSerializer.translateOutput(returnObj);
	}
	...
	public br.com.prodevelopment.associado.model.Associado createAssociado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { associadoId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.associado.model.Associado deleteAssociado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { associadoId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.associado.model.Associado fetchAssociado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { associadoId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.associado.model.Associado getAssociado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName13,
					_methodParameterTypes13, new Object[] { associadoId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<br.com.prodevelopment.associado.model.Associado> getAssociados(
		...
		return (java.util.List<br.com.prodevelopment.associado.model.Associado>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public br.com.prodevelopment.associado.model.Associado addAssociado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					ClpSerializer.translateInput(idPolishop),
						
					ClpSerializer.translateInput(idLojaIndicada),
						
					ClpSerializer.translateInput(idPatrocinador),
	...
	public br.com.prodevelopment.associado.model.Associado deleteAssociado(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName25,
					...
					new Object[] { ClpSerializer.translateInput(associado), userId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public void updateAsset(long userId,
		...
		try {
			_invokableLocalService.invokeMethod(_methodName26,
				...
				ClpSerializer.translateInput(associado),
	...
	public br.com.prodevelopment.associado.model.Associado fetchByCPF_CNPJ(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName36,
					...
					new Object[] { ClpSerializer.translateInput(cpfCnpj) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.associado.model.Associado fetchByRG_INSCRICAO(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName37,
					...
					new Object[] { ClpSerializer.translateInput(rgInscricao) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.associado.model.Associado fetchByOD_POLISHOP(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName38,
					...
					new Object[] { ClpSerializer.translateInput(idPolishop) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
