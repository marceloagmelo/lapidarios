 ...
 * @generated
 */
public class LojaExportActionableDynamicQuery extends LojaActionableDynamicQuery {
	public LojaExportActionableDynamicQuery(
	...
	protected void addCriteria(DynamicQuery dynamicQuery) {
		...
		if (_portletDataContext.isInitialPublication()) {
			...
			StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(Loja.class.getName());
