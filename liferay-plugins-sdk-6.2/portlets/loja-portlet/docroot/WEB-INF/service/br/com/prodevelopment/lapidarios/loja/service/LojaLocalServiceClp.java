 ...
 * @generated
 */
public class LojaLocalServiceClp implements LojaLocalService {
	public LojaLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodParameterTypes39 = new String[] { "long", "long", "long", "int[][]" };
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja addLoja(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(loja) });
		}
		catch (Throwable t) {
		...
		return (br.com.prodevelopment.lapidarios.loja.model.Loja)ClpSerializer.translateOutput(returnObj);
	}
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja createLoja(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { lojaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja deleteLoja(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { lojaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja fetchLoja(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { lojaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja getLoja(long lojaId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName13,
					_methodParameterTypes13, new Object[] { lojaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<br.com.prodevelopment.lapidarios.loja.model.Loja> getLojas(
		...
		return (java.util.List<br.com.prodevelopment.lapidarios.loja.model.Loja>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja addLoja(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					ClpSerializer.translateInput(razaoSocial),
						
					ClpSerializer.translateInput(nomeFantasia),
						
					ClpSerializer.translateInput(observacaoMap),
						
					ClpSerializer.translateInput(cnpj),
						
					ClpSerializer.translateInput(endLogradouro),
						
					ClpSerializer.translateInput(endNumero),
						
					ClpSerializer.translateInput(endComplemento),
						
					ClpSerializer.translateInput(endCep),
						
					ClpSerializer.translateInput(endBairro),
						
					ClpSerializer.translateInput(endCidade),
						
					ClpSerializer.translateInput(endUf),
						
					ClpSerializer.translateInput(endPais),
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja moveLojaToTrash(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName26,
					...
					new Object[] { userId, ClpSerializer.translateInput(loja) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja restoreLojaFromTrash(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName28,
					_methodParameterTypes28, new Object[] { userId, lojaId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public br.com.prodevelopment.lapidarios.loja.model.Loja updateStatus(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName29,
					...
					ClpSerializer.translateInput(loja),
