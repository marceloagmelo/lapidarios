...
import br.com.prodevelopment.lapidarios.loja.service.LojaLocalService;
import br.com.prodevelopment.lapidarios.loja.service.persistence.LojaPersistence;
...
/**
 * Provides the base implementation for the loja local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.com.prodevelopment.lapidarios.loja.service.impl.LojaLocalServiceImpl}.
 * </p>
 *
 * @author Marcelo Melo
 ...
 * @generated
 */
public abstract class LojaLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LojaLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link br.com.prodevelopment.lapidarios.loja.service.LojaLocalServiceUtil} to access the loja local service.
	 */
	...
	@Override
	public Loja addLoja(Loja loja) throws SystemException {
		loja.setNew(true);

		return lojaPersistence.update(loja);
	}
	 ...
	 */
	@Override
	public Loja createLoja(long lojaId) {
		return lojaPersistence.create(lojaId);
	}
	...
	public Loja deleteLoja(long lojaId) throws PortalException, SystemException {
		return lojaPersistence.remove(lojaId);
	}
	...
	public Loja deleteLoja(Loja loja) throws SystemException {
		return lojaPersistence.remove(loja);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Loja.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return lojaPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return lojaPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return lojaPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return lojaPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Loja fetchLoja(long lojaId) throws SystemException {
		return lojaPersistence.fetchByPrimaryKey(lojaId);
	}
	 ...
	 */
	@Override
	public Loja fetchLojaByUuidAndCompanyId(String uuid, long companyId)
		throws SystemException {
		return lojaPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public Loja fetchLojaByUuidAndGroupId(String uuid, long groupId)
		throws SystemException {
		return lojaPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public Loja getLoja(long lojaId) throws PortalException, SystemException {
		return lojaPersistence.findByPrimaryKey(lojaId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return lojaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public Loja getLojaByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException, SystemException {
		return lojaPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public Loja getLojaByUuidAndGroupId(String uuid, long groupId)
		throws PortalException, SystemException {
		return lojaPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<Loja> getLojas(int start, int end) throws SystemException {
		return lojaPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLojasCount() throws SystemException {
		return lojaPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Loja updateLoja(Loja loja) throws SystemException {
		return lojaPersistence.update(loja);
	}

	/**
	 * Returns the loja local service.
	 *
	 * @return the loja local service
	 */
	public br.com.prodevelopment.lapidarios.loja.service.LojaLocalService getLojaLocalService() {
		return lojaLocalService;
	}

	/**
	 * Sets the loja local service.
	 *
	 * @param lojaLocalService the loja local service
	 */
	public void setLojaLocalService(
		br.com.prodevelopment.lapidarios.loja.service.LojaLocalService lojaLocalService) {
		this.lojaLocalService = lojaLocalService;
	}

	/**
	 * Returns the loja remote service.
	 *
	 * @return the loja remote service
	 */
	public br.com.prodevelopment.lapidarios.loja.service.LojaService getLojaService() {
		return lojaService;
	}

	/**
	 * Sets the loja remote service.
	 *
	 * @param lojaService the loja remote service
	 */
	public void setLojaService(
		br.com.prodevelopment.lapidarios.loja.service.LojaService lojaService) {
		this.lojaService = lojaService;
	}

	/**
	 * Returns the loja persistence.
	 *
	 * @return the loja persistence
	 */
	public LojaPersistence getLojaPersistence() {
		return lojaPersistence;
	}

	/**
	 * Sets the loja persistence.
	 *
	 * @param lojaPersistence the loja persistence
	 */
	public void setLojaPersistence(LojaPersistence lojaPersistence) {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("br.com.prodevelopment.lapidarios.loja.model.Loja",
			lojaLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = lojaPersistence.getDataSource();
	...
	@BeanReference(type = br.com.prodevelopment.lapidarios.loja.service.LojaLocalService.class)
	protected br.com.prodevelopment.lapidarios.loja.service.LojaLocalService lojaLocalService;
	@BeanReference(type = br.com.prodevelopment.lapidarios.loja.service.LojaService.class)
	protected br.com.prodevelopment.lapidarios.loja.service.LojaService lojaService;
	@BeanReference(type = LojaPersistence.class)
	protected LojaPersistence lojaPersistence;
	...
	private LojaLocalServiceClpInvoker _clpInvoker = new LojaLocalServiceClpInvoker();
}