...
public class EnderecoEmailUtil {
	...
	public static EnderecoEmail getEnderecoEmail(HttpServletRequest request)
		...
		long enderecoEmailId = ParamUtil.getLong(request, CadastroLojaConstants.ENDERECO_EMAIL_ID);
		...
		request.setAttribute(CadastroLojaConstants.ENDERECO_EMAIL, enderecoEmail);
		request.setAttribute(CadastroLojaConstants.ENDERECO_EMAIL_ID, enderecoEmailId);
	...
	public static List<EnderecoEmail> getEnderecosEmail(ActionRequest actionRequest,
		...
		int principal = ParamUtil.getInteger(actionRequest,
				CadastroLojaConstants.CAMPO_ENDERECO_EMAIL_PRINCIPAL);

		for (int enderecosEmailIndex : enderecosEmailIndexes) {
			long enderecoEmailId = ParamUtil.getLong(actionRequest,
					CadastroLojaConstants.ENDERECO_EMAIL_ID + enderecosEmailIndex);

			int tipo = ParamUtil.getInteger(actionRequest,
					CadastroLojaConstants.CAMPO_TIPO_ENDERECO_EMAIL + enderecosEmailIndex);
			String endereco = ParamUtil.getString(actionRequest,
					CadastroLojaConstants.CAMPO_ENDERECO_EMAIL_ENDERECO + enderecosEmailIndex);
